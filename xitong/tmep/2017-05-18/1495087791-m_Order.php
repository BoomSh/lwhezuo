...
public function xsz($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,type')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
...
public function xszss($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,username,type')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
        if($check == 1){
...
public function xszx($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,role,type')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 148;
                    $whid['is_show'] = 1;
    ...
    public function xszx_add(){
        if(request()->isPost()){$data['role'] = input('role');$data['type'] = input('type');
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function xszx_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['role'] = input('role');$data['type'] = input('type');
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function xsazaz($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,type,role')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 150;
...
public function xcv($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,type,username')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 151;
                    $whid['is_show'] = 1;
    ...
    public function xcv_add(){
        if(request()->isPost()){$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function xcv_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function lsxz($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,role,lbq,type,username')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 130;
                    $whid['is_show'] = 1;
    ...
    public function lsxz_add(){
        if(request()->isPost()){$data['role'] = input('role');$data['lbq'] = input('lbq');$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function lsxz_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['role'] = input('role');$data['lbq'] = input('lbq');$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function xcxz($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,type,role,lbq')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 131;
...
public function xczx($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,username,type')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
...
public function xzxc($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,username,type,role')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
        if($check == 1){
...
public function xzcx($page,$check){
        $res['row'] =  Db::table('wx_aa')->field('id,type,username,role,lbq')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();$sql = Db::table("wx_aa")->getlastsql();
                    $star = stripos($sql,'where');
                    $res['sql'] = substr($sql,$star);
                    $whid['auth_id'] = 134;
