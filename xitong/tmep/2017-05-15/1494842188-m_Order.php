...
public function xwq($page,$check){
        $res['row'] = db('aa')->field('id,role')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
        if($check == 1){
    ...
    public function xwq_add(){
        if(request()->isPost()){$data['role'] = input('role');
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function xwq_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['role'] = input('role');
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function ksx($page,$check){
        $res['row'] = db('aa')->field('id,role')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
...
public function sasd($page,$check){
        $res['row'] = db('aa')->field('id,type')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
        if($check == 1){
...
public function sad($page,$check){
        $res['row'] = db('aa')->field('id,type,lbq,role')->where($check)->order('id desc')->limit(($page-1)*2,2)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/2);
        if($check == 1){
...
public function sxaw($page,$check){
        $res['row'] = db('aa')->field('id,role,text,lbq,file,type,username')->where($check)->order('id desc')->limit(($page-1)*20,20)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/20);
        if($check == 1){
    ...
    public function sxaw_add(){
        if(request()->isPost()){$data['role'] = input('role');$data['text'] = input('text');$data['lbq'] = input('lbq');$data['file'] = input('file');$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function sxaw_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['role'] = input('role');$data['text'] = input('text');$data['lbq'] = input('lbq');$data['file'] = input('file');$data['type'] = input('type');$data['username'] = implode(',',input('username/a'));
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function wsx($page,$check){
        $res['row'] = db('aa')->field('id,lbq,text,role,type')->where($check)->order('id desc')->limit(($page-1)*2,2)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/2);
        if($check == 1){
          ...
          $url = $_SERVER['REQUEST_URI']."?text=".input('text')."&lbq=".input('lbq')."&page=".$page;
        }
        $res['page'] = $this->pages($num,$page,$url);
        return $res;
    }
    public function wsx_add(){
        if(request()->isPost()){$data['lbq'] = input('lbq');$data['text'] = input('text');$data['role'] = input('role');$data['type'] = input('type');
        $res = db('aa')->insert($data);
            if($res){
              return 'success';
            }else{
    ...
    public function wsx_edit(){
        if(request()->isPost()){$data['id'] = input('id');$data['lbq'] = input('lbq');$data['text'] = input('text');$data['role'] = input('role');$data['type'] = input('type');
            $res = db('aa')->update($data);
            if($res){
              return 'success';
            }else{
...
public function isnx($page,$check){
        $res['row'] = db('aa')->field('id,type,role,lbq,text')->where($check)->order('id desc')->limit(($page-1)*2,2)->select();
        $num = db('aa')->field('COUNT(*)')->where($check)->find();
        $res['num'] = $num['COUNT(*)'];
        $num = ceil($num['COUNT(*)']/2);
        if($check == 1){
          ...
          $url = $_SERVER['REQUEST_URI']."?role=".input('role')."&lbq=".input('lbq')."&
        page=".$page;}
        $res['page'] = $this->pages($num,$page,$url);
        return $res;
    }
    public function isnx_add(){
