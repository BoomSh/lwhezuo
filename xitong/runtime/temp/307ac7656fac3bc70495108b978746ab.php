...
function listsadd(){
    ...
    $.post("<?php echo url('Menu/listsadd'); ?>",{auth_name:auth_name,auth_c:auth_c,auth_a:auth_a,pid:pid,remark:remark},function(data){
        if(data == "success"){
                 layer.msg('添加成功!');
                setTimeout(function () {
