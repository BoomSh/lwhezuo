<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"E:\EclipseProject\xitong\public/../application/admin\view\admin\dictionary_list.html";i:1504777617;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Admin/dictionary_list'); ?>" method="get">
...
<?php endif; ?>
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            ...
            <a href="javascript:;" onclick="member_add('添加字典','<?php echo url('Admin/dictionary_add'); ?>','','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加字典</a>
            <?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('Admin/dictionary_edit',array('id'=>$vo['id'])); ?>','4','','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Admin/dictionary_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
