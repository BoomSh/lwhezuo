<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"/Users/wangchunlei/ykd99/lwhezuo/xitong/public/../application/admin/view/menu/dictionary_list.html";i:1504938590;s:92:"/Users/wangchunlei/ykd99/lwhezuo/xitong/public/../application/admin/view//Public/header.html";i:1504663244;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span>字典列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<?php if($lw_role['find'] == 1): ?>
<form action="<?php echo url('Menu/dictionary_list'); ?>" method="get">
    <div class="bk-gray radius pd-10 col-xs-12 col-sm-12 ">
        <div class="mt-10 col-xs-12 col-sm-12">
            <strong class="col-xs-12 col-sm-2 text-r">字典字段：</strong>
...
<?php endif; ?>
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            ...
            <a href="javascript:;" onclick="member_add('添加字典','<?php echo url('Menu/dictionary_add'); ?>','','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加字典</a>
            <?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('Menu/dictionary_edit',array('id'=>$vo['id'])); ?>','4','','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Menu/dictionary_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
