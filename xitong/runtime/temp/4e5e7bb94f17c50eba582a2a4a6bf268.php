<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\detailed\detailed_list.html";i:1506650829;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\header.html";i:1506649687;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\footer.html";i:1506649687;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Detailed/detailed_list'); ?>" method="get">
    <div class="text-c">   
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            ...
            <?php if($lw_role['add'] == 1): ?><a href="javascript:;" onclick="member_add('添加业主','detailed_add.html','','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加业主</a><?php endif; ?>
            </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <?php if($lw_role['edit'] == 1): ?><a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('Detailed/detailed_edit',array('id'=>$vo['id'])); ?>','4','','550')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Detailed/detailed_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
