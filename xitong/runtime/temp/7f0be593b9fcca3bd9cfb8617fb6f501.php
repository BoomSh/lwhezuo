<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\EclipseProject\xitong\public/../application/admin\view\admin\listsadd.html";i:1504836502;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
function listsadd(){
    ...
    $.post("<?php echo url('Admin/listsadd'); ?>",{auth_name:auth_name,auth_c:auth_c,auth_a:auth_a,pid:pid,remark:remark},function(data){
        if(data == "success"){
                 layer.msg('添加成功!');
                setTimeout(function () {
