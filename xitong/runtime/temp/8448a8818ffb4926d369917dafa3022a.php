<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"E:\EclipseProject\xitong\public/../application/admin\view\admin\system_add.html";i:1504778633;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="uploadfile" name="uploadfile">
            </div>
        </div>
        <div class="row cl">
...
$(function(){
    ...
    $("#form-member-add").validate({
        ...
        submitHandler:function(form){
             $(form).ajaxSubmit({
                type: 'post',
                url: "<?php echo url('Admin/system_add'); ?>",
