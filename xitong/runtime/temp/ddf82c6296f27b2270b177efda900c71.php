                        ...
                        <dl class="cl permission-list2">
                            ...
                            <dd>
                                ...
                                <label class="">
                                    ...
                                    查看</label>
                                <label class="">
                                    <input type="checkbox" value="<?php echo $v['id']; ?>-5" name="auth[]" <?php if($v['role_5'] == 5): ?>checked<?php endif; ?>>
                                    审核</label>
                            </dd>
                        </dl>
...
$(function(){
    ...
    $("#form-admin-role-add").validate({
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                type: 'post',
                url: "<?php echo url('Menu/admin_role_edit'); ?>",
