                        ...
                        <dl class="cl permission-list2">
                            ...
                            <dd>
                                <?php if($v['add'] == 1): ?><label class="">
                                    ...
                                    删除</label><?php endif; if($v['find'] == 1): ?><label class="">
                                    <input type="checkbox" value="<?php echo $v['id']; ?>-4" name="auth[]">
                                    查看</label><?php endif; if($v['status'] == 1): ?><label class="">
                                    <input type="checkbox" value="<?php echo $v['id']; ?>-5" name="auth[]">
                                    审查</label><?php endif; ?>
                            </dd>
                        </dl>
