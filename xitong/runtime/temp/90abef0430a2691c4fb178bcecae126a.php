<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\cuscontract\electric_list.html";i:1506650832;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\header.html";i:1506649687;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\footer.html";i:1506649687;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Cuscontract/electric_list'); ?>" method="get">
    <div class="bk-gray radius pd-10 col-xs-12 col-sm-12">
        ...
        <div class="mt-10 col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" class="input-text"  placeholder="输入电表名称" id="" value="<?php echo $name; ?>" name="name">
            </div>
        </div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            <?php if($lw_role['del'] == 1): ?><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>　　<?php endif; if($lw_role['excelin'] == 1): ?><a href="javascript:;" onclick="member_add('导入抄表数据','electric_excelin.html','','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe645;</i> 导入抄表数据</a><?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <?php if($lw_role['edit'] == 1): ?><a title="编辑" href="javascript:;" onclick="member_edit('编辑','electric_edit.html?id=<?php echo $vo['id']; ?>','4','','400')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; if($lw_role['del'] == 1): ?><a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; if($lw_role['add'] == 1): ?><a title="抄表" href="javascript:;" onclick="member_edit('抄表','electric_add.html?id=<?php echo $vo['id']; ?>','4','','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe600;</i></a><?php endif; ?>
                    <a title="记录" href="javascript:;" onclick="member_show('抄表记录','electrichistory_list.html?id=<?php echo $vo['id']; ?>','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe720;</i></a>
                </td>
            </tr>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Cuscontract/electric_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
