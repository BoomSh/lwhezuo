<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\EclipseProject\xitong\public/../application/admin\view\admin\lists.html";i:1504837086;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Admin/lists'); ?>" method="get">
...
<?php endif; ?>
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            <?php if($lw_role['del'] == 1): ?><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a><?php endif; if($lw_role['add'] == 1): ?><a href="javascript:;" onclick="admin_permission_add('添加菜单','<?php echo url('Admin/listsadd'); ?>','','400')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加菜单</a><?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="admin_permission_edit('菜单编辑','<?php echo url('Admin/listsedit',array('id'=>$vo['id'])); ?>','1','','400')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_permission_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){  
        $.post("<?php echo url('Admin/listsdel'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
