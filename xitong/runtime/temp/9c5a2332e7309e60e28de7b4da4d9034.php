<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\EclipseProject\xitong\public/../application/admin\view\menu\admin_role.html";i:1504836845;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
    ...
    <?php if($lw_role['del'] == 1): ?><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <?php endif; if($lw_role['add'] == 1): ?><a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo url('Menu/admin_role_add'); ?>','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> <?php endif; ?>
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','<?php echo url('Menu/admin_role_edit',array('id'=>$vo['id'])); ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_role_del(obj,id){
    layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
        $.post("<?php echo url('Menu/admin_role_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
