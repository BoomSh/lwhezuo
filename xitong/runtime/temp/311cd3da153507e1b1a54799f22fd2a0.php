<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\login\login.html";i:1505048578;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal" action="index-1.html" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo url('Login/verify'); ?>" class="form-label col-xs-3" style='width:130px;margin-top:-2px;height:45px;'> <a id="kanbuq" href="javascript:verify();">看不清，换一张</a> </div>
      </div>
      <!-- <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
