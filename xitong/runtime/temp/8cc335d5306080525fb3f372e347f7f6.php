<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\finance\income_list.html";i:1506656528;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\header.html";i:1506649687;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\footer.html";i:1506649687;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form action="<?php echo url('Finance/income_list'); ?>" method="post">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
		<span class="l">
			<?php if($lw_role['add'] == 1): ?><a href="javascript:;" onclick="admin_add('添加收入','<?php echo url('Finance/income_add'); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加收入</a><?php endif; ?>&nbsp;
			<?php if($lw_role['excelin'] == 1): ?><a href="javascript:;" onclick="member_add('导入缴款费用','<?php echo url('Finance/income_excelin'); ?>','','300')" class="btn btn-secondary radius"><i class="Hui-iconfont">&#xe645;</i>导入缴款费用</a><?php endif; ?>
		</span>
		<span class="r">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo customerName($vo['payment_id']); ?></td>
				<td><?php echo staffName($vo['payee_id']); ?></td>
                ...
                <a title="编辑" href="javascript:;" onclick="admin_edit('编辑','<?php echo url('Finance/income_edit',array('id'=>$vo['id'])); ?>','4','','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                <?php endif; ?>
				</td>
			</tr>
		 <?php endforeach; endif; else: echo "" ;endif; ?>	
