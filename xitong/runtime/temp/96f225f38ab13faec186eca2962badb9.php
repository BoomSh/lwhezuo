...
<?php endif; ?>
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            <?php if($lw_role['del'] == 1): ?><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a><?php endif; if($lw_role['add'] == 1): ?><a href="javascript:;" onclick="admin_permission_add('添加菜单','<?php echo url('Menu/listsadd'); ?>','','400')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加菜单</a><?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="admin_permission_edit('菜单编辑','<?php echo url('Menu/listsedit',array('id'=>$vo['id'])); ?>','1','','400')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
