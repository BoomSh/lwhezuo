<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\finance\expenditure_edit.html";i:1506657366;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\header.html";i:1506649687;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\footer.html";i:1506649687;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
	  <input type="hidden" value="<?php echo $res['id']; ?>" name="id"></input>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text payment_input" t_id='payment_id' value="<?php echo staffName($res['payment_id']); ?>" autocomplete="off" placeholder="" id="" name="payment_name">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text payee_input" t_id='payee_id' value="<?php echo customerName($res['payee_id']); ?>" autocomplete="off" placeholder="" id="" name="payee_name">
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
                type: 'post',
                url: "<?php echo url('Finance/expenditure_edit'); ?>",
	...
	//付款
	keyword($(".payment_input"),$(".keyword_payment"),2);
	//收款
	keyword($(".payee_input"),$(".keyword_payee"),3);
