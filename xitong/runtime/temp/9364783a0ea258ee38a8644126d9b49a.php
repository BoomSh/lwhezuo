<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"E:\EclipseProject\xitong\public/../application/admin\view\admin\systemlog_list.html";i:1504837212;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Admin/systemlog_list'); ?>" method="get">
...
function system_log_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Admin/systemlog_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
