<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\enterprise\garden_list.html";i:1506650839;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\header.html";i:1506649687;s:81:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\\public\footer.html";i:1506649687;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Enterprise/garden_list'); ?>" method="post">
	<div class="bk-gray radius pd-10 col-xs-12 col-sm-12">
		<div class="mt-10 col-xs-12 col-sm-12">
			...
			<div class="col-xs-12 col-sm-6">
				<input type="text" class="input-text" placeholder="输入园区名称" value="<?php echo $name; ?>" id="" name="name">
			</div>
		</div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($res['list']) || $res['list'] instanceof \think\Collection): $i = 0; $__LIST__ = $res['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td><?php echo $vo['lessee_area']; ?></td>
				<td><?php echo $vo['lease_area']; ?></td>
				<td><?php echo $vo['company_id']; ?></td>
				<td><?php echo $vo['bank_id']; ?></td>
				<td><?php echo $vo['finance_id']; ?></td>
				<td><?php echo $vo['finance_m']; ?></td>
				<td><?php echo $vo['managers_id']; ?></td>
				<td><?php echo $vo['managers_m']; ?></td>
				<td class="td-manage">
				<?php if($lw_role['edit'] == 1): ?>
                <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('Enterprise/garden_edit',array('id'=>$vo['id'])); ?>','4','','300')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Enterprise/garden_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
