<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\EclipseProject\xitong\public/../application/admin\view\index\index.html";i:1504851594;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
        ...
        <dl id="menu-article">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <!--<li><a data-href="engineering-income-list.html" data-title="工程收入" href="javascript:void(0)">第三方收入</a></li>-->
                    <!--<li><a data-href="engineering-expendi-list.html" data-title="工程支出" href="javascript:void(0)">第三方支出</a></li>-->
                    <!--<li><a data-href="detailed-engineering-expendi-list.html" data-title="收入明细" href="javascript:void(0)">第三方明细</a></li>-->
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-article">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <!--<li><a data-href="cost-list.html" data-title="业主费用" href="javascript:void(0)">业主费用</a></li>-->
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <!--<li><a data-href="cost-list.html" data-title="客户费用" href="javascript:void(0)">客户费用</a></li>-->
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <!--<li><a data-href="income-cost-list.html" data-title="客户房租" href="javascript:void(0)">客户房租</a></li>-->
                    <!--<li><a data-href="income-cost-list.html" data-title="业主房租" href="javascript:void(0)">业主房租</a></li>-->
                    <!--<li><a data-href="detailed-income-list.html" data-title="收入明细" href="javascript:void(0)">收入明细</a></li>-->
                    <li><a data-href="expendi-list.html" data-title="支出管理" href="javascript:void(0)">支出管理</a></li>
                    <!--<li><a data-href="detailed-expendi-list.html" data-title="支出明细" href="javascript:void(0)">明细管理</a></li>-->
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
