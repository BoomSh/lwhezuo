<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"E:\EclipseProject\xitong\public/../application/admin\view\admin\admin_edit.html";i:1504851623;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="<?php echo $res['username']; ?>" placeholder="" id="adminName" name="adminName">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="password" class="input-text" autocomplete="off" value="<?php echo $res['y_pwd']; ?>" placeholder="密码" id="password" name="password">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="password" class="input-text" autocomplete="off"  placeholder="确认新密码" id="password2" name="password2" value="<?php echo $res['y_pwd']; ?>">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="<?php echo $res['mobile']; ?>" placeholder="" id="phone" name="phone">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" placeholder="@" name="email" id="email" value="<?php echo $res['email']; ?>">
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
            <select class="select" name="adminRole" size="1">
                <option value="<?php echo $res['role_id']; ?>"><?php echo $res['role_name']; ?></option>
                <option value="0">超级管理员</option>
                <?php if(is_array($role['list']) || $role['list'] instanceof \think\Collection): $i = 0; $__LIST__ = $role['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <textarea name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true"><?php echo $res['remark']; ?></textarea>
...
$(function(){
    ...
    $("#form-admin-add").validate({
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                type: 'post',
                url: "<?php echo url('Admin/admin_edit'); ?>",
