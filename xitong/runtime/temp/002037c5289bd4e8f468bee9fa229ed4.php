<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"E:\EclipseProject\xitong\public/../application/admin\view\admin\dictionary_edit.html";i:1504776544;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $res['name']; ?>" placeholder="" id="username" name="username">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="checkbox" name="time" value="1" <?php if($res['status'] == 2): ?>checked<?php endif; ?>/>
            </div>
        </div>
        <div class="row cl">
...
$(function(){
    ...
    $("#form-member-add").validate({
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                type: 'post',
                url: "<?php echo url('Admin/dictionary_edit'); ?>",
