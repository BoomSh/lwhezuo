<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"F:\wamp64\www\lwhezuo\xitong\public/../application/admin\view\index\index.html";i:1506649687;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<aside class="Hui-aside">
    ...
    <?php if(is_array($ban) || $ban instanceof \think\Collection): $i = 0; $__LIST__ = $ban;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <dl id="menu-article">
            <dt class="selected"><?php echo $vo['img']; ?> <?php echo $vo['auth_name']; ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
