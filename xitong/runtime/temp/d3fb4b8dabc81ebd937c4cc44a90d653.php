<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\EclipseProject\xitong\public/../application/admin\view\menu\adminlist.html";i:1504836968;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:77:"E:\EclipseProject\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<form action="<?php echo url('Menu/adminlist'); ?>" method="get">
...
<?php endif; ?>
    <div class="cl pd-5 bg-1 bk-gray mt-20 col-xs-12 col-sm-12">
        <span class="l">
            <?php if($lw_role['del'] == 1): ?><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a><?php endif; if($lw_role['add'] == 1): ?><a href="javascript:;" onclick="admin_add('添加管理员','<?php echo url('Menu/admin_add'); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a><?php endif; ?>
        </span>
        <span class="r">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
            ...
            <tr class="text-c">
                ...
                <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','<?php echo url('Menu/admin_edit',array('id'=>$vo['id'])); ?>','2','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo url('Menu/admin_del'); ?>",{id:id},function(data){
            if(data == "success"){
                layer.msg("删除成功");
...
function admin_stop(obj,id){
    layer.confirm('确认要停用吗？',function(index){
        ...
        $.post("<?php echo url('Menu/admin_state'); ?>",{id,id,type:2},function(data){
            if(data == "success"){
...
function admin_start(obj,id){
    layer.confirm('确认要启用吗？',function(index){
        $.post("<?php echo url('Menu/admin_state'); ?>",{id,id,type:1},function(data){
            if(data == "success"){
                var status = $(obj).parents("tr").find(".td-status");
                 //此处请求后台程序，下方是成功后的前台处理……
