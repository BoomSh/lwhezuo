<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp64\www\xitong\public/../application/admin\view\menu\listsedit.html";i:1504937367;s:73:"D:\wamp64\www\xitong\public/../application/admin\view\\Public\header.html";i:1504663245;s:73:"D:\wamp64\www\xitong\public/../application/admin\view\\Public\footer.html";i:1504664541;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <label><input type="checkbox" name="auths" value="4" <?php if($res['auths']['find'] == 1): ?>checked<?php endif; ?>/>查询</label>
                <label><input type="checkbox" name="auths" value="5" <?php if($res['auths']['status'] == 1): ?>checked<?php endif; ?>/>审查</label>
            </div>
        </div>
        <div class="row cl">
